...
From the boxplot and radar charts below, metric by sex shown that male has higher value than female. 
...
From the radar chart below, it is clear that male physical value is higher than female. Chinstrap has the highest value in bill depth and bill length compare to other species. 
...
Below bar plot shown number of observation by island and species. Adelie lives in the three islands, but Gentoo and Chinstrap lives in Biscoe island and Dream island, respectively.
...
The following plot describe measurement of physical appearance from 2017 to 2019. It may draw penguin scientist attention to preserve penguins species considering Adelie and Chinstrap species overcome decreasing bill depth, and body mass. 

```{r yoy-metric, fig.width=12}
penguins %>%
  ...
  facet_wrap(~ metric, scales = "free") +
  labs(x = "Year", y = "", title = "Physical growth of penguins from 2017 to 2019") +
...
Missing data existed for Adelie and Gentoo. Imputation missing data on sex variable is performed based on metric's value. Radar chart above clearly shown influence metric for each species and sex.  
...
sum_mean %>%
  ...
  set_header_labels(species = "Species", sex = "Sex", bill_length_mm = "Bill Length (in mm)",
                    bill_depth_mm = "Bill Depth (in mm)", flipper_length_mm = "Flipper Length (in mm)",
